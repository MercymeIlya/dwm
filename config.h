...
static const char col_cyan[]        = "#6667ab";    /* Top bar second color (blue) and active window border color */
...
static const char *spotifynext[] = {"dbus-send", "--dest=org.mpris.MediaPlayer2.spotify", "--type=method_call", "/org/mpris/MediaPlayer2", "org.mpris.MediaPlayer2.Player.Next" };
static const char *spotifyprev[] = {"dbus-send", "--dest=org.mpris.MediaPlayer2.spotify", "--type=method_call", "/org/mpris/MediaPlayer2", "org.mpris.MediaPlayer2.Player.Previous" };
static const char *spotifyplaypause[] = {"dbus-send", "--dest=org.mpris.MediaPlayer2.spotify", "--type=method_call", "/org/mpris/MediaPlayer2", "org.mpris.MediaPlayer2.Player.PlayPause" };
