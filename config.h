...
static const char *spotifynext[] = {"/home/ilya/bin/set_playback", "Next", NULL };
static const char *spotifyprev[] = {"/home/ilya/bin/set_playback", "Previous", NULL };
static const char *upbrightness[] = { "brightnessctl", "-d", "nvidia_wmi_ec_backlight", "set", "+10", NULL };
static const char *downbrightness[] = { "brightnessctl", "-d", "nvidia_wmi_ec_backlight", "set", "10-", NULL };
...
static Key keys[] = {
	...
	{ 0,                            XF86XK_AudioPlay,         spawn,  {.v = (const char*[]) { "/home/ilya/bin/set_playback", "PlayPause" } } },
